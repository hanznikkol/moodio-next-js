...
export default function Footer() {
  return (
    <footer className="fixed bottom-0 left-0 w-full border-t border-black/20 dark:border-white/10 backdrop-blur-sm select-none z-10 text-black dark:text-white">
      <div className="max-w-screen-lg mx-auto px-4 py-3 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 text-xs sm:text-sm">
        ...
        <div className="flex flex-wrap items-center justify-center gap-1 sm:gap-2 text-center">
          ...
          <a
            ...
            className="flex items-center gap-1 font-bold text-black dark:text-white hover:text-pink-500 dark:hover:text-pink-500 transition-colors duration-200"
          >
        ...
        {/* Powered By */}
        <div className="flex items-center gap-1 px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 text-white shadow-md mt-1 sm:mt-0">
